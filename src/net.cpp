...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "KateCoin Version " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"dnsseed1", "47.88.27.161"},
    {"dnsseed2", "115.28.27.232"},
	{"dnsseed3", "coin.katecoin.com"},
	{"dnsseed4", "101.200.184.237"},
	{"dnsseed5", "123.56.79.198"},
	{"dnsseed6", "101.200.192.199"},
	{"dnsseed7", "101.200.198.233"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. KateCoin is probably already running."), addrBind.ToString().c_str());
        else
