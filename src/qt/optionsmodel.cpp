...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::KTC).toInt();
    nDecimalPoints = settings.value("nDecimalPoints", BitcoinUnits::decimals(BitcoinUnits::KTC)).toInt();
