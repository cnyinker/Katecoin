    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a KateCoin address (e.g. 8UFH6jMFxKAP73wQqfLiDY2LN4RgUbTa9A)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a KateCoin address (e.g. 8UFH6jMFxKAP73wQqfLiDY2LN4RgUbTa9A)"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter KateCoin signature"));
#endif
