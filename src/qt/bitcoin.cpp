...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. KateCoin can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "KateCoin",
    ...
    app.setOrganizationName("KateCoin");
    //XXX app.setOrganizationDomain("");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("KateCoin-Qt-testnet");
    else
        app.setApplicationName("KateCoin-Qt");
    ...
    try
    {
        ...
        if(AppInit2())
        {
            {
#ifdef PROFILER // For CPU profiling
                ProfilerStart("katecoin-qt.prof");
#endif
