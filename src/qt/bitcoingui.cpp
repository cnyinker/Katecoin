    ...
    rpcConsole(0)
{
    ...
    setWindowTitle(tr("KateCoin Wallet"));
...
*/
    ...
    // Create GetKateCoin Page
    //getKateCoinPage = new GetKateCoinPage();
    ...
    //centralWidget->addWidget(getKateCoinPage);
...
void BitcoinGUI::lockWalletFeatures(bool lock)
{
    ...
    else
    {
        ...
        QSettings settings("KateCoin", "KateCoin-Qt");
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(QIcon(":/icons/overview"), tr("概况"), this);
    overviewAction->setToolTip(tr("Wallet Overview"));
    overviewAction->setCheckable(true);
    overviewAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_1));
    tabGroup->addAction(overviewAction);

    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("发送"), this);
    sendCoinsAction->setToolTip(tr("Send KateCoin"));
    ...
    historyAction = new QAction(QIcon(":/icons/history"), tr("交易"), this);
    ...
    /* Reserved for future
    //getKateCoinAction = new QAction(QIcon(":/icons/getkatecoin"), tr("Get KateCoin"), this);
    //getKateCoinAction->setToolTip(tr("Buy KateCoin with Fiat or Bitcoin"));
    //getKateCoinAction->setCheckable(true);
    //getKateCoinAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
    //tabGroup->addAction(getKateCoinAction);
    */

    claimsAction = new QAction(QIcon(":/icons/claims"), tr("官网"), this);
    claimsAction->setToolTip(tr("Join the KateCoin Community\nApply for Energy Claims"));
    ...
    //chatAction->setToolTip(tr("Join the KateCoin Chat Room"));
    ...
    */
    ...
    blockchainAction->setToolTip(tr("Explore the KateCoin Blockchain"));
    ...
    //connect(getKateCoinAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    //connect(getKateCoinAction, SIGNAL(triggered()), this, SLOT(gotoGetKateCoinPage()));
    ...
    aboutAction = new QAction(QIcon(":/icons/about"), tr("&About KateCoin"), this);
    aboutAction->setToolTip(tr("Show information about KateCoin"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for KateCoin"));
    ...
    //forumAction = new QAction(QIcon(":/icons/forums"), tr("KateCoin &Forum"), this);
    //forumAction->setToolTip(tr("Go to the KateCoin Forum."));
    webAction = new QAction(QIcon(":/icons/site"), tr("www.katecoin.com"), this);
    webAction->setToolTip(tr("Go to KateCoin website."));
...
void BitcoinGUI::createToolBars()
{
    ...
    //toolbar->addAction(getKateCoinAction);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("KateCoin Wallet") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::setWalletModel(WalletModel *walletModel)
{
    ...
    if(walletModel)
    {
        ...
        //getKateCoinPage->setModel(walletModel);
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("KateCoin Wallet"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%1 active connection%2 to the KateCoin network").arg(count).arg(count == 1 ? "" : "s"));
}
    ...
    QString strMessage =
        tr("This transaction is over the size limit.  You can still send it for a fee of %1, "
          ...
          "Do you want to pay the fee?").arg(
                BitcoinUnits::formatWithUnitFee(BitcoinUnits::KTC, nFeeRequired));
...
/* Disabled
void BitcoinGUI::gotoGetKateCoinPage()
{
    getKateCoinAction->setChecked(true);
    centralWidget->setCurrentWidget(getKateCoinPage);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid KateCoin address or malformed URI parameters."));
    }
...
void BitcoinGUI::checkForUpdate()
{
    ...
    if (fNewVersion)
    {
        ...
        std::string basename = GetArg("-vFileName","katecoin-qt");
