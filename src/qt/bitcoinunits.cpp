...
QString BitcoinUnits::name(int unit)
{
    ...
    case uKTC: return QString::fromUtf8("μKTC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case KTC: return QString("KateCoins");
    case mKTC: return QString("Milli-KateCoins (1 / 1,000)");
    case uKTC: return QString("Micro-KateCoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case KTC: return 10; // 2,100,000,000 (# digits, without commas)
    case mKTC: return 13; // 2,100,000,000,000
    case uKTC: return 16; // 2,100,000,000,000,000
    default: return 0;
    }
}
