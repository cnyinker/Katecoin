...
static const int64_t INITIAL_COIN_SUPPLY = 21000000; // Used in calculating interest rate (97.990085882B are out of circulation)
static const int TWO_PERCENT_INT_HEIGHT = 3000 ;

static const double COIN_SUPPLY_GROWTH_RATE = 1.35; // Circulation growth rate per block based on KTC grants of 710,000 / year
static const double TWO_PERCENT_INT = 4.0;
...
static const int64_t MAX_MONEY = 1000000000000 * COIN; // KateCoin: maximum of 98.1 billion coins
static const double PI = 3.1415926535;

// KateCoin PoW specific
...
static const int64_t DUST_HARD_LIMIT = 1000;   // 0.00001 KTC mininput
...
static const unsigned int MAX_TX_COMMENT_LEN_V1 = 140; // KateCoin:  128 bytes + little extra
...
public:
    ...
    */
    ...
    bool GetStakeTime(CTxDB& txdb, uint64_t& nStakeTime, CBlockIndex* pindexPrev) const;  // KateCoin: get transaction staketime
